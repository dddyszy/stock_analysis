...
from app.services.jobs import JobAlreadyRunning, run_job
...
def start_scheduler() -> None:
    ...
    scheduler.add_job(job_scores, CronTrigger(day_of_week="sat", hour=10), id="scores", replace_existing=True)
